...
public class MainActivity extends Activity {
    ...
    @Override public void onCreate(Bundle b) {
        ...
        box.addView(text("Sacá una captura donde se vean los juegos o su información. La app leerá únicamente esa imagen y ordenará lo detectado por RTP visible o de referencia.",16,Color.LTGRAY));
